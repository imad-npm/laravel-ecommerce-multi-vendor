<x-app-layout>
    <x-slot name="header">
        <div class="mb-6">
            ...
            <p class="text-sm text-neutral-500">Free shipping on orders over $50</p>
        </div>

        @include('partials.product.filters')
    </x-slot>

    <div class="py-12 bg-gradient-to-b from-neutral-50 to-white">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if($products->isEmpty())
                <div class="bg-white p-10 rounded-lg shadow text-center text-neutral-600">
