                                                ...
                                                <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                                                    @if ($orders->isEmpty())
                                                        <div
                                                            ...
                                                            <p class="text-lg font-semibold">You haven't placed any
                                                                orders yet.</p>
                                                            <a href="{{ route('products.index') }}"
                                                                class="mt-4 inline-block px-5 py-2 bg-indigo-600 text-white text-sm rounded shadow hover:bg-indigo-700 transition">
                                                                Browse Products
                                                                ...
                                                                <table class="min-w-full divide-y divide-gray-200">
                                                                    ...
                                                                    <tbody class="bg-white divide-y divide-gray-100">
                                                                        @foreach ($orders as $order)
                                                                            <tr class="hover:bg-gray-50 transition">
                                                                                <td
                                                                                    class="px-4 py-4 whitespace-nowrap font-bold text-indigo-700">
                                                                                    #{{ $order->id }}</td>
                                                                                <td
                                                                                    class="px-4 py-4 whitespace-nowrap text-gray-500">
                                                                                ...
                                                                                <td
                                                                                    class="px-4 py-4 whitespace-nowrap font-semibold text-gray-900">
                                                                                ...
                                                                                <td class="px-4 py-4 whitespace-nowrap">
                                                                                    ...
                                                                                    @endphp
                                                                                    <span
                                                                                        class="px-3 py-1 text-xs rounded-full font-semibold {{ $statusClass }}
                                            ">
                                                                                    ...
                                                                                    @if ($order->status === OrderStatus::PENDING)
                                                                                        ...
                                                                                        @if ($diffSeconds > 0)
                                                                                            <div x-data="{ remaining: {{ $diffSeconds }} }"
                                                                                                ...
                                                                                                <span>
                                                                                                    <span
                                                                                                        x-text="Math.floor(remaining / 3600)"></span>h
                                                                                                    <span
                                                                                                        x-text="Math.floor((remaining % 3600) / 60)"></span>m
                                                                                                    remaining to pay
                                                                                                </span>
                                                                                            </div>
                                                                                        @else
                                                                                ...
                                                                                <td
                                                                                    class="px-4 py-4 whitespace-nowrap text-right flex">
                                                                                    ...
                                                                                    @if ($order->status === OrderStatus::PENDING)
                                                                                        <a href="{{ route('customer.orders.checkout', $order->id) }}"
