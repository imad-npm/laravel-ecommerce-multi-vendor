   ...
   <x-guest-layout>
       ...
       <form method="POST" action="{{ route('register') }}">
           @csrf
           <x-ui.button href="{{ route('google.redirect') }}" variant="outline" class="mb-2 w-full items-center">
           ...
           <div>
               ...
               <x-ui.input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')"
           ...
           <div class="mt-4">
               ...
               @endphp
               <x-ui.select-dropdown id="role" name="role" :options="$roles" :selected="old('role')" required
                   class="mt-1 w-full" />
