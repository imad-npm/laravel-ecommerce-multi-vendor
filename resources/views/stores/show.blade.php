<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-6 mb-4">
            ...
            @endif
            <div>
                <h1 class="text-3xl font-bold mb-1 text-gray-900">{{ $store->name }}</h1>
                <div class="flex items-center gap-3 text-gray-600 text-sm mb-1">
                    <span>Vendor: <span class="font-semibold text-indigo-700">{{ $store->user->name ?? 'N/A' }}</span></span>
                    <span class="ml-4 flex items-center">
                        ...
                        <span class="font-semibold">{{ $avgRating }}</span> <span class="ml-1 text-xs text-gray-400">/ 5</span>
                    </span>
                </div>
