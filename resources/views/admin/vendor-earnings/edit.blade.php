            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-neutral-200">
                    <form action="{{ route('admin.vendor-earnings.update', $vendorEarning) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="mb-4">
                            <label for="payout_id" class="block text-neutral-700 text-sm font-bold mb-2">{{ __('Payout') }}</label>
                            <select name="payout_id" id="payout_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-neutral-700 leading-tight focus:outline-none focus:shadow-outline">
                        ...
                        <div class="mb-4">
                            <label for="is_paid" class="block text-neutral-700 text-sm font-bold mb-2">{{ __('Is Paid') }}</label>
                            <select name="is_paid" id="is_paid" class="shadow appearance-none border rounded w-full py-2 px-3 text-neutral-700 leading-tight focus:outline-none focus:shadow-outline">
