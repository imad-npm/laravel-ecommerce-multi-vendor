    ...
    <div class="py-10 bg-neutral-50">
        <div class="max-w-4xl mx-auto bg-white p-6 rounded shadow">
            ...
            <form method="POST" action="{{ route('admin.orders.update', $order) }}">
                ...
                <!-- User info (read only) -->
                <div class="mb-6">
                    <label class="block text-sm font-medium text-neutral-700">Customer</label>
                    <input type="text" value="{{ $order->customer->name ?? 'Unknown' }}" readonly
                           class="mt-1 block w-full border-neutral-300 rounded-md p-2 bg-neutral-100 text-neutral-600">
                </div>

                <!-- Shipping Address (read only) -->
                <div class="mb-6">
                    <label class="block text-sm font-medium text-neutral-700">Shipping Address</label>
                    <div class="mt-1 block w-full border-neutral-300 rounded-md p-2 bg-neutral-100 text-neutral-600">
                ...
                <div class="mb-6">
                    ...
                    <select name="status" required
                            class="mt-1 block w-full border-neutral-300 rounded-md p-2 focus:ring-primary focus:border-primary">
                ...
                <!-- Total (readonly) -->
                <div class="mb-6">
                    <label class="block text-sm font-medium text-neutral-700">Total</label>
