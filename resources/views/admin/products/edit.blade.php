                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" required
                            ...
                            class="mt-1 block w-full rounded-md border-neutral-300 shadow-sm focus:ring-primary focus:border-primary sm:text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                            class="mt-1 block w-full rounded-md border-neutral-300 shadow-sm focus:ring-primary focus:border-primary sm:text-sm">{{ old('description', $product->description) }}</textarea>
                    </div>
                    ...
                    <!-- Image -->
                    <div>
                        <label for="image" class="block text-sm font-medium text-neutral-700">Update Image</label>
                        <input type="file" name="image" id="image"
                            class="mt-1 block w-full text-sm text-neutral-600 file:border file:border-neutral-300 file:rounded file:px-3 file:py-1 file:bg-white hover:file:bg-neutral-100 file:cursor-pointer">
                        @if($product->image)
                            <div class="mt-3">
